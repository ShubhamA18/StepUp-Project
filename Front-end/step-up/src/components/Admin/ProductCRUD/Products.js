...
const Products = () => {
    ...
    return (
        <div className='container mt-3'>
            ...
            <Link to='/admin/addProduct' className='btn btn-dark'>Add Product <i className="fa fa-plus" aria-hidden="true"></i></Link>
            <br />
            <br />
            <div>
                {/* Table start here */}
                            ...
                            product.map((val, index) => {
                                return <tr key={index + 1}>
                                    ...
                                    <td>
                                        ...
                                        <Link to={`/admin/editProduct/${val.productId}`} className='btn btn-outline-primary'>
